...
<body>
                            ...
                            <div class="card-header" style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid var(--card-border);">
                                ...
                                <div class="card-actions" style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    <div class="eng-log-date-filter-wrap" style="display: inline-flex; align-items: center; gap: 6px;">
                                        <input type="date" id="eng-activity-date-input" class="chart-time-filter" style="padding: 4px 8px; font-size: 0.78rem; border-radius: 6px; cursor: pointer;" onchange="fetchDailyActivityLogs()">
                                    </div>
    ...
    <!-- ponytail: App Logic -->
    <script src="app.js?v=41.0"></script>
</body>
