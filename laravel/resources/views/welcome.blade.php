...
<body>
                ...
                <section id="tab-general-ejo" class="tab-pane">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-field">
                                    ...
                                    <select id="gejo-form-priority" required>
                                        <option value="1">1 - High (Urgent / Line Stop / Bahaya HSE)</option>
                    ...
                    <div class="project-board" id="gejo-kanban-board">
                        ...
                        <div class="gejo-outstanding-group" id="gejo-outstanding-group">
                            ...
                            <div class="gejo-outstanding-columns">
                                ...
                                <div class="project-column card-glass" id="gejo-col-fase1">
                                    <div class="column-header ch-fase1">
                                ...
                                <div class="project-column card-glass" id="gejo-col-fase2">
                                    <div class="column-header ch-fase2">
                                        <!-- ponytail: show only Schedule/On Progress/Done names in headers, removing Fase prefix and extra details -->
                                        <h4>On Progress</h4>
                        ...
                        <div class="project-column card-glass" id="gejo-col-fase3">
                            <div class="column-header ch-fase3">
                                <!-- ponytail: show only Schedule/On Progress/Done names in headers, removing Fase prefix and extra details -->
                                <h4>Done</h4>
                        ...
                        <div class="project-column card-glass" id="gejo-col-fase4" style="display: none;">
                            <div class="column-header ch-archive">
                                <h4>Archive</h4>
                ...
                <section id="tab-projects" class="tab-pane">
                    ...
                    <div class="project-board">
                        ...
                        <div class="project-column card-glass" id="col-fase5" style="display: none;">
                            <div class="column-header ch-fase5" style="border-top-color: var(--color-cyan);">
    ...
    <div class="modal-backdrop" id="excel-sheet-modal">
        <div class="modal-card card-glass animate-in excel-sheet-modal-card">
            <div class="modal-header excel-sheet-modal-header">
                <div>
                    <h3 class="excel-sheet-modal-title">Pilih Sheet Excel</h3>
                    <p class="excel-sheet-modal-subtitle">File ini memiliki beberapa sheet. Pilih sheet EJO yang ingin
                        diimpor.</p>
                </div>
            ...
            <div class="modal-body excel-sheet-modal-body">
                <div class="excel-sheet-picker">
                    <div class="excel-sheet-picker-head">
                        <label for="excel-sheet-select">Daftar Sheet</label>
                        <span>Pilih salah satu sheet yang tersedia</span>
                    </div>
                    <div class="excel-sheet-list" id="excel-sheet-list" role="listbox" aria-label="Daftar sheet excel">
                    </div>
                    <select id="excel-sheet-select" class="excel-sheet-select-native" aria-hidden="true" tabindex="-1">
                        <!-- Options will be added dynamically -->
                    </select>
                    <div class="excel-sheet-selected" id="excel-sheet-selected">Sheet terpilih: -</div>
                </div>
            </div>
            <div class="excel-sheet-modal-actions">
                ...
                <button class="btn btn-primary glow-button full-width" id="excel-sheet-btn-confirm" type="button">Mulai
                    Impor</button>
            </div>
        </div>
    </div>
