...
<body>
                ...
                <section id="tab-overview" class="tab-pane active">
                    ...
                    <div class="overview-activity-standalone-row" id="overview-eng-activity-panel" style="margin-top: 1.5rem; width: 100%;">
                        <div class="list-card card-glass eng-activity-card">
                            <div class="card-header" style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid var(--card-border); position: relative; z-index: 2;">
                                <div class="card-header-left" style="gap: 10px;">
                                    <div class="card-icon-wrap card-icon-cyan" style="width: 38px; height: 38px; border-radius: 9px;">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary text-xs" style="margin: 3px 0 0 0; font-size: 0.78rem;">Rekap laporan tugas &amp; status personil per tanggal</p>
                                    </div>
                                </div>
                                <div class="card-actions" style="display: flex; align-items: center; gap: 10px;">
                                    ...
                                    <div class="eng-log-date-filter-wrap" style="display: inline-flex; align-items: center; gap: 6px;">
                                        <input type="date" id="eng-activity-date-input" class="chart-time-filter" style="padding: 5px 10px; font-size: 0.82rem; border-radius: 6px; cursor: pointer;" onchange="fetchDailyActivityLogs()">
                                    </div>
                                    <!-- Manual Add Button (Restricted to Admin & Foreman Eng) -->
                                    <button type="button" class="btn btn-primary btn-xs" id="btn-add-daily-activity" style="display: none; padding: 6px 12px; font-size: 0.8rem; border-radius: 6px; gap: 5px;" onclick="openAddDailyActivityModal()">
                                        <i data-lucide="plus" style="width: 14px; height: 14px;"></i> Tambah Log
                                    </button>
                                    <span class="badge" id="eng-activity-total-badge" style="background: rgba(6, 182, 212, 0.12); color: var(--color-cyan); font-size: 0.76rem; font-weight: 600; padding: 4px 10px; border-radius: 12px; border: 1px solid rgba(6, 182, 212, 0.25);">0 Entri</span>
                                </div>
                            </div>
                        ...
                        <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                            ...
                            <div class="search-wrapper" style="min-width: 260px;">
                                <input type="text" id="search-drawing-gallery"
                                    placeholder="Cari judul, ID drawing...">
                            </div>
                        </div>
                    </div>
                        ...
                        <form id="user-admin-form">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-field" id="user-password-field-container">
                                    <label for="usr-password">Password <span class="text-muted" style="font-size: 0.78rem; font-weight: normal;">(Otomatis terisi sama dengan username)</span></label>
                                    <div class="password-input-wrapper">
                                        <input type="text" id="usr-password" placeholder="Otomatis mengikuti username"
                                            required>
                                    ...
                                    <small class="text-muted" style="font-size: 0.75rem; margin-top: 4px; display: block;">
                                        💡 <em>Password otomatis terisi nama akun (username). Anda tetap bisa mengubahnya jika diperlukan.</em>
                                    </small>
                                </div>
                                <div class="form-field">
            ...
            <div class="modal-body modal-drawing-body">
                ...
                <div class="modal-main-info modal-drawing-main-info">
                    ...
                    <p class="text-secondary" style="margin-top: -0.25rem; font-size: 0.85rem;">
                        <i data-lucide="user"
                            style="width: 14px; height: 14px; display: inline; vertical-align: middle; margin-right: 4px;"></i>
                        Pemohon: <strong id="modal-drawing-requester" style="color: var(--text-primary);">-</strong>
                        <span id="modal-drawing-uploader-wrapper">&bull; Pengunggah: <span id="modal-drawing-uploader">-</span></span>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            <!-- Drafter Card -->
                            <div class="card-glass" id="card-sig-drafter"
                                style="padding: 12px; display: flex; align-items: center; justify-content: space-between; border: 1px solid var(--card-border); border-radius: var(--border-radius-md);">
                                <div>
                                    <div id="sig-title-drafter"
                                        style="font-size: 0.8rem; font-weight: bold; color: var(--text-secondary);">
                                        PEMBUAT DRAWING (DRAFTER/ENG)</div>
                                    <div id="sig-info-drafter"
                                        style="font-size: 0.75rem; color: var(--text-muted); margin-top: 2px;">Menunggu
                                    </div>
                                </div>
                                <div id="sig-img-container-drafter"
                                    style="display: flex; align-items: center; gap: 8px;">
    ...
    <!-- MODAL: DAILY ENGINEER ACTIVITY LOG DETAILS & TABLE (POPUP TENGAH) -->
    <div class="modal-backdrop" id="modal-daily-activity-table" style="display: none;">
        <div class="modal-card card-glass" style="max-width: 1100px; width: 95vw; max-height: 88vh; display: flex; flex-direction: column;">
            <div class="modal-header" style="padding: 1.15rem 1.5rem; border-bottom: 1px solid var(--card-border); display: flex; justify-content: space-between; align-items: center;">
                <div class="modal-title-group" style="display: flex; align-items: center; gap: 10px;">
                    <div class="card-icon-wrap card-icon-cyan" style="width: 36px; height: 36px; border-radius: 8px;">
                        <i data-lucide="clipboard-list" style="width: 20px; height: 20px;"></i>
                    </div>
                    <div>
                        <h3 style="font-size: 1.1rem; font-weight: 700; color: var(--text-primary); margin: 0;">Log Aktivitas Engineer</h3>
                        <p class="text-secondary text-xs" style="margin: 2px 0 0 0;">Rekap laporan tugas & status personil per tanggal</p>
                    </div>
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <!-- Date selector inside modal -->
                    <input type="date" id="modal-eng-activity-date-input" class="chart-time-filter" style="padding: 4px 10px; font-size: 0.82rem; border-radius: 6px; cursor: pointer;" onchange="syncModalActivityDate(this.value)">
                    <!-- Add button inside modal -->
                    <button class="btn btn-primary btn-xs" id="modal-btn-add-activity" style="display: none; padding: 5px 12px; font-size: 0.78rem; border-radius: 6px; gap: 5px;" onclick="openAddDailyActivityModal()">
                        <i data-lucide="plus" style="width: 13px; height: 13px;"></i> Tambah Log
                    </button>
                    <button type="button" class="modal-close" onclick="closeDailyActivityTableModal()"><i data-lucide="x"></i></button>
                </div>
            </div>
            <div class="modal-body" style="padding: 1.25rem; overflow-y: auto; flex: 1; min-height: 0;" id="modal-overview-eng-activity-list">
                <!-- Dual WhatsApp-style table rendered dynamically -->
            </div>
        </div>
    </div>

    <!-- MODAL: ADD / EDIT DAILY ACTIVITY LOG (MANUAL INPUT BY ADMIN & FOREMAN ENG) -->
    <div class="modal-backdrop" id="modal-daily-activity" style="display: none;">
        <div class="modal-card card-glass" style="max-width: 550px;">
            <div class="modal-header">
                <div class="modal-title-group" style="display: flex; align-items: center; gap: 8px;">
                    <div class="card-icon-wrap card-icon-cyan" style="width: 32px; height: 32px; border-radius: 8px;">
                        <i data-lucide="plus-circle" id="modal-activity-title-icon" style="width: 18px; height: 18px;"></i>
                    </div>
                    <h3 style="font-size: 1.05rem; font-weight: 700; color: var(--text-primary);" id="modal-activity-title-text">Tambah Log Aktivitas Manual</h3>
                </div>
            ...
            <div class="modal-body" style="padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                <input type="hidden" id="input-activity-edit-id" value="">
                ...
                <div class="form-group">
                    ...
                    <select id="input-activity-group" class="form-control" style="width: 100%; padding: 8px 12px; border-radius: 8px; background: rgba(255,255,255,0.05); border: 1px solid var(--card-border); color: var(--text-primary);" onchange="handleActivityGroupChange()">
                        <option value="ALL">Semua Tim (EJO & Drafter)</option>
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative; margin-bottom: 6px;">
                        ...
                        <i data-lucide="search" style="position: absolute; left: 9px; top: 50%; transform: translateY(-50%); width: 13px; height: 13px; color: var(--text-secondary); opacity: 0.6; pointer-events: none;"></i>
                    </div>
                    <div id="input-activity-engineers-list" style="max-height: 180px; overflow-y: auto; display: flex; flex-direction: column; width: 100%; box-sizing: border-box; padding-right: 4px; border: 1px solid var(--card-border); border-radius: 8px; background: rgba(255,255,255,0.02); padding: 6px;">
                        <!-- Dynamically filled with ENG users checklist -->
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                        <label style="font-size: 0.8rem; font-weight: 600; color: var(--text-secondary); margin-bottom: 0;">Pilih Tiket EJO / Drawing On-Progress (Opsional):</label>
                        <span id="input-activity-ejo-count" style="font-size: 0.72rem; color: var(--color-cyan, #06b6d4); font-weight: 600;">0 tiket aktif</span>
                    </div>
                    <div id="input-activity-ejo-list" style="max-height: 160px; overflow-y: auto; display: flex; flex-direction: column; width: 100%; box-sizing: border-box; padding-right: 4px; border: 1px solid var(--card-border); border-radius: 8px; background: rgba(255,255,255,0.02); padding: 6px; gap: 4px;">
                        <!-- Dynamically filled with active on-progress EJO list cards -->
                    </div>
                </div>
            </div>
            <div class="modal-footer" style="padding: 1rem 1.25rem; display: flex; justify-content: flex-end; gap: 8px; border-top: 1px solid var(--card-border);">
                ...
                <button type="button" class="btn btn-primary glow-button" id="btn-submit-daily-activity" onclick="submitManualDailyActivity()"><i data-lucide="check" style="width: 14px; height: 14px;"></i> <span id="btn-submit-daily-activity-text">Simpan Log</span></button>
            </div>
        </div>
    </div>
    ...
    <!-- ponytail: App Logic -->
    <script src="app.js?v=68.0"></script>
</body>
